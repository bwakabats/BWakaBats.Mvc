var BootstrapUtilities = function ()
{
    ...
    self.fixForm = function ($container, canBeDirty)
    {
        ...
        if ($container.datetimepicker != undefined)
        {
            ...
            else
            {
                awesomeIcons = {
                    ...
                    today: "fas fa-crosshairs fa-fw",
                    clear: "fas fa-trash-o fa-fw",
                    close: "fas fa-remove fa-fw"
                };
            }
        ...
        $container.find("[data-icon5picker]").each(function ()
        {
            if (typeof BootstrapIcon5Picker === "undefined")
            {
                utilities.message("Javascript Missing", "The javascript file for the BWakaBats icon5 picker is missing");
                return false;
            }
            ...
            var $button = $container.find("#" + id + "_Button");
            var $popup = $container.find("#" + id + "_Popup");
            var $icon = $container.find("#" + id + "_Icon");
            var $name = $container.find("#" + id + "_IconName");
            $this.data("icon5picker", new BootstrapIcon5Picker($this, $button, $popup, $icon, $name));
        });
    ...
    self.checkFontVersion = function ()
    {
